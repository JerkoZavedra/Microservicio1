...
public class GlobalExceptionHandler {
    ...
    /**
     * Captura errores cuando no se encuentra un envío por ID.
     */
    @ExceptionHandler(EnvioNotFoundException.class) // <-- CAMBIADO
    public ResponseEntity<Object> handleEnvioNotFound(EnvioNotFoundException ex) { // <-- CAMBIADO
